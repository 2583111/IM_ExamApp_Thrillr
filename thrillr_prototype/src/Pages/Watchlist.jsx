...
export default function WatchlistPage() {
  ...
  useEffect(() => {
    const mIDs = getList('watchlist-movie');
    const sIDs = getList('watchlist-series');
  ...
  return (
    <div className="lists-container">
      <div className="list-title-wrapper">
        <h2 className="list-title">Your Watchlist</h2>
      </div>

      <section style={{ marginTop: '2rem' }}>
        <h2 style={{ margin: 0, marginBottom: '0.5rem' }}>Movies</h2>
        {movieItems.length === 0 ? (
          <p className="empty-text">No movies in your watchlist.</p>
        ) : (
          <div
            style={{
              display: 'grid',
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        {seriesItems.length === 0 ? (
          <p className="empty-text">No series in your watchlist.</p>
        ) : (
          <div
            style={{
              display: 'grid',
